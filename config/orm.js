...
var orm = {
  ...
  insert: function(tableInput, param, value, cb){
    var queryString = "INSERT INTO ?? (??) VALUES (?)";
    connection.query(queryString, [tableInput, param, value], function(err, result){
      if(err){
        throw err;
      }
      cb(result);
  ...
  update: function(tableInput, col1toUpdate, value1, col2toUpdate, value2, cb){
